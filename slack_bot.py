...
import cv2
import numpy as np
from dark_img_tool import *

config_file = 'cascade_rcnn_x101_64x4d_fpn_1x.py'
checkpoint_file = 'cascade_mask_rcnn_x101_64x4d_fpn_20e_20181218-630773a7.pth'

model = init_detector(config_file, checkpoint_file, device='cuda:0')

token="your token number" #your bot token comes here
